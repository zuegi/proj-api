...
@Service
public class InMemoryCommandDispatcher implements DispatchCommands {
    ...
    public <C extends Command, R> void registerHandler(Class commandType, CommandHandler<C, R> handler) {
